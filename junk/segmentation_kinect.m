...
flile_header = 'clothes_dataset_kinect';
%create firectory
...
for iter_i = 1:length(clothes)
    ...
    for iter_j = 1:length(captures)
        ...
        [ mask ] = copema_segmentation(strcat(dataFile,'_rgb.png'), strcat(dataFile,'_mask.png'), './ClopemaSegmentation/out/rgb_model_kinect.mat');
        pause(1)
        close all
    end
    %%
