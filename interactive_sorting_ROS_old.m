...
para.isnorm = 0 % norm of data for each dimention
...
[ ROS_INFO ] = graspingPoseEstamitation(graspingCandidates, ridgeMap, imresizeScale*0.5, PL, PR, dispMH, dispMV );
...
clearvars -except predict_label prob position3D_ROS gripperDir_ROS position2D_ROS normal_ROS;
